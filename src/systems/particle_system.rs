...
pub fn cull_dead_particles(ecs: &mut World, ctx: &BTerm) {
    ...
    for dead_particle in dead_particles.iter() {
        ecs.delete_entity(*dead_particle)
            .expect("Unable to remove a dead particle.");
    }
}
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for new_particle in particle_builder.requests.iter() {
            ...
            positions
                ...
                .expect("Unable to insert position component to particle");
            renderables
                .insert(
                    p,
                    Renderable {
                ...
                .expect("Unable to insert renderable component to particle");
            particles
                .insert(
                    p,
                    ParticleLifetime {
                ...
                .expect("Unable to insert lifetime component to particle");
        }
